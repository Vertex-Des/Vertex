...
Vertex is a student-run nonprofit that teaches high schoolers how to use [Desmos](https://www.desmos.com/) — the free graphing calculator built into the Digital SAT — as a primary problem-solving tool, not just something to double-check work with.
